...
$vorname = $_SESSION['vorname']; // Vorname des Nutzers
$name = $_SESSION['name']; // Nachname des Nutzers
$admin = $_SESSION['admin']; // Überprüfung, ob der Benutzer ein Administrator ist
...
<header>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; width: 100%; z-index: 1000; margin: 0; top: 0;">
