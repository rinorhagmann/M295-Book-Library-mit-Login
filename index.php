      ...
      <img class="bd-placeholder-img" src="img/bg3.jpg" width="100%" height="100%" alt="Book Image" style="opacity: 0.5;">
        <div class="container">
          <div class="carousel-caption text-end">
            <h1>Möchten Sie sich mit Ihrem Konto anmelden?</h1>
            <p>Als angemeldeter Benutzer können Sie auf exklusive Angebote zugreifen und Ihre Lieblingsbücher verwalten.</p>
            <p><a class="btn btn-lg btn-primary" href="login.php">Melden Sie sich an</a></p>
          </div>
        </div>
      </div>
    </div>
